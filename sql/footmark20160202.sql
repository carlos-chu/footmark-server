...
CREATE TABLE `comment` (
  ...
  `source_type` tinyint(2) NOT NULL DEFAULT '1' COMMENT '评论源的类型，1：脚印，2：评论',
  `parent_id` bigint(20) DEFAULT NULL COMMENT '父id，对应评论本身，即root根评论',
  `target_user_id` bigint(20) DEFAULT NULL COMMENT '目标用户的id',
...
CREATE TABLE `counter` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_sourceid_type_uid` (`user_id`,`source_id`,`source_type`,`counter_type`)
...
CREATE TABLE `letter` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `parent_id` bigint(20) DEFAULT NULL COMMENT '私信的父id，为空则为他自己',
  `from_uid` bigint(20) NOT NULL COMMENT '发送方id',
  `to_uid` bigint(20) NOT NULL COMMENT '接受方id',
  `content` varchar(500) NOT NULL COMMENT '私信内容',
  `read_status` tinyint(2) DEFAULT '0' COMMENT '阅读状态，0：未读，1：已读，2：忽略',
  `create_time` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `status` tinyint(2) DEFAULT '0' COMMENT '状态：0：正常，1：删除，2：举报',
  PRIMARY KEY (`id`)
...
CREATE TABLE `push_info` (
  ...
  `update_time` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_userid_bduserid_channelid` (`bd_user_id`,`bd_channel_id`,`user_id`) USING BTREE,
  KEY `idx_userid` (`user_id`)
...
CREATE TABLE `user_friend` (
  ...
  `accept_status` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'friend接受状态，0：未发送，1：未接受，2：已接受，3：拒绝',
